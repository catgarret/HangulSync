...
enum L10n {
    ...
    private static let table: [String: [Key: String]] = [
        "en": [
            ...
            .statusStandby: "Standby — starts automatically when a remote desktop app is in use",
            .statusPaused: "Paused",
        ...
        "ko": [
            ...
            .statusSyncing: "동기화 중",
            .statusStandby: "대기 중 — 원격 데스크탑 앱을 사용하면 자동으로 시작됩니다",
            .statusPaused: "일시정지됨",
        ...
        "ja": [
            ...
            .statusSyncing: "同期中",
            .statusStandby: "待機中 — リモートデスクトップアプリの使用中に自動で開始します",
            .statusPaused: "一時停止中",
        ...
        "zh-Hans": [
            ...
            .statusSyncing: "同步中",
            .statusStandby: "待机 — 使用远程桌面应用时自动开始",
            .statusPaused: "已暂停",
        ...
        "zh-Hant": [
            ...
            .statusSyncing: "同步中",
            .statusStandby: "待機 — 使用遠端桌面應用時自動開始",
            .statusPaused: "已暫停",
        ...
        "th": [
            ...
            .statusSyncing: "กำลังซิงค์",
            .statusStandby: "สแตนด์บาย — จะเริ่มอัตโนมัติเมื่อใช้แอปรีโมตเดสก์ท็อป",
        ...
        "ru": [
            ...
            .statusSyncing: "Синхронизация активна",
            .statusStandby: "Ожидание — включится автоматически при использовании удалённого рабочего стола",
        ...
        "it": [
            ...
            .statusSyncing: "Sincronizzazione attiva",
            .statusStandby: "In attesa — si attiva automaticamente quando usi un'app di desktop remoto",
